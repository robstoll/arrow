...
eitherTVal
//EitherT(value=ObservableKW(observable=io.reactivex.internal.operators.observable.ObservableJust@525c7452))
```
...
```kotlin
eitherTVal.value()
//ObservableKW(observable=io.reactivex.internal.operators.observable.ObservableJust@525c7452)
```
...
//EitherT(value=Some(Left(a=4, dummy=kotlin.Unit)))
```
